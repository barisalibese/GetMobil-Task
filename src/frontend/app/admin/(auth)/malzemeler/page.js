                    ...
                    <div className="kt-portlet__head-toolbar">
                        <div className="kt-portlet__head-wrapper">
                            <div className="kt-portlet__head-actions">
                                ...
                                <a href="/admin/malzemeler/ekle" className="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <div className="kt-portlet__body">
                    ...
                    >
                        ...
                        {data.map((value,key)=>(
                            ...
                            <td> {value.type}</td>
                            <td>
                                <a className="btn btn-primary" href={'/admin/malzemeler/'+value.id}><i className="fa fa-edit"></i>Güncelle</a>
                            </td>
                            </tr>
                        ))}
                        </tbody>
