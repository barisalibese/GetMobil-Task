                ...
                <div className="kt-container ">
                    ...
                    <div className="kt-header__brand   kt-grid__item" id="kt_header_brand">
                        <div className="kt-header__brand-logo">
                            <a href="/admin">
                                <img alt="Logo" src="/admin/assets/media/logos/logo-2.png" className="kt-header__brand-logo-default"/>
                                <img alt="Logo" src="/admin/assets/media/logos/logo-2-sm.png" className="kt-header__brand-logo-sticky"/>
                            </a>
                        </div>
                    </div>
                    {/* end:: Brand */}
                                                ...
                                                <div className="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                                                    <ul className="kt-menu__subnav">
                                                        <li className="kt-menu__item " aria-haspopup="true">
                                                            <a href="components/utils/session-timeout.html" className="kt-menu__link "><i className="kt-menu__link-bullet kt-menu__link-bullet--dot">
